...
import org.flavio.pl0.Symbol;
import org.flavio.pl0.SymbolType;
import org.flavio.pl0.TokenEvaluator;
...
public class TokenEvaluatorTest {
    ...
    public void testEvaluate() throws Exception {
        Assert.assertEquals(new Symbol(SymbolType.CONST,"CONST"),evaluator.evaluate("const"));
